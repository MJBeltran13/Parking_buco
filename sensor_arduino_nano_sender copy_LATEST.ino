...
#define ZERO_POINT_VOLTAGE     (3.3504/8.5) // Output of the sensor in volts at 400PPM CO2 concentration for 5V sensor
...
float MGRead(int mg_pin) {
  ...
  v = (v / READ_SAMPLE_TIMES) * (3.9 / 1024); // Convert to voltage for 3.9V
  return v;
}
...
void proximity() {
  ...
  Serial.println(distance_sensor_0);
